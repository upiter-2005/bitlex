...
function Sell({activePair, usdt, makeOrder}) {
    ...
    <div className="col-md-6">
      ...
      <form onSubmit={handlerSubmitOrder}>
        <p>
          ...
          <input type="number" className="bb1" placeholder={activePair.currency} />
        </p>
        <p>
          <label htmlFor="bb1">Кол-во:</label>
          <input type="number" className="bb11" ref={refAmount}  placeholder="0" />
        </p>
        ...
        <p>
          ...
          <input type="text" id="bb3" className="blcahin" placeholder={activePair.currency} />
        </p>
